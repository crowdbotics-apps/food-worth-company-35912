...
## Project Structure
    ...
    ├── food_worth_company_35912  # Django project configurations
...
1. Clone this repo and `cd food_worth_company_35912`
...
2. Clone this repo and `cd food_worth_company_35912`
